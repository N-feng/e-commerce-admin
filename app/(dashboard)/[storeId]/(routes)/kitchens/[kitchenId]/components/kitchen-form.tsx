...
export const KitchenForm: React.FC<KitchenFormProps> = ({
  initialData
}) => {
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.storeId}/kitchens/${params.sizeId}`);
      router.refresh();
      router.push(`/${params.storeId}/kitchens`);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Kitchen name" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Kitchen value" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
